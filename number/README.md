...
-m SUFFIX      指定邮箱后缀，例如 @163.com；不指定时随机使用默认后缀
...
```text
已生成 10 条结果，已输出到文件: ~/Desktop/out.txt
```
